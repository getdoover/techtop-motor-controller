...
STATES = [DISCONNECTED, NOT_READY, READY, STARTING, RUNNING, STOPPING, TRIPPED, RESETTING]
...
class MotorController:
    ...
    transitions = [
        ...
        # Ready / not ready
        {"trigger": "became_ready", "source": [NOT_READY, STOPPING, STARTING], "dest": READY},
        {"trigger": "lost_ready", "source": [READY, STARTING, STOPPING], "dest": NOT_READY},
        # Start sequence
        ...
        {"trigger": "stopped_externally_not_ready", "source": RUNNING, "dest": NOT_READY},
        # Trips
    ...
    async def spin(self, status: DriveStatus | None, *, control_allowed: bool, max_iterations: int = 6) -> str:
    ...
    async def evaluate(self, status: DriveStatus | None, *, control_allowed: bool) -> None:
